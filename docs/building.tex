...
For this, you will need a \texttt{git} client to make pull requests, and \texttt{Qt} version 4 or later (5.2 preferred) installed for compiling to work. In addition you may want to install \texttt{Qt Creator} to edit the base project.
